...
--retornar todos os registros da tabela cadstro, referentes aos funcionários Marinae Eduardo
...
--selecionar as colunas nome e sobrenome da tabela cadastro e simular um aumento no salário de 10%, colocando um apelido na coluna com o nome de "AUMENTO".
